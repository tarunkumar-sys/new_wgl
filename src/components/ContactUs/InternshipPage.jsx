...
//       />
//       <FormField
//         label="Tantative Date of joining"
//         name="joinDate"
//         type="date"
...
//         to_email: "worldgreenlinecommunity@gmail.com", // Replace with your email
...
const InternshipPage = () => {
  ...
  const validateForm = (formData, type) => {
    ...
    // Email validation only if email field exists and is not empty
    ...
    if (type === "internship") {
      ...
      // Duration and joinDate are optional for internship based on your form comments
      // Resume is also optional based on your form comments
    } else if (type === "volunteer") {
      // All fields are optional except contact based on your form comments
    } else if (type === "other") {
      if (!formData.experience.trim()) {
        alert("Please describe your work experience.");
        return false;
      ...
      // joinDate is optional for "other" based on your form comments
    }
