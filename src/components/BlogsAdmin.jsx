...
// import { ChevronRight, Leaf, Zap, Sun, X, Trash, Plus, Heart, MessageCircle, Trash2, Tag, Hand, Edit, Users } from 'lucide-react';
...
//             {post.category === 'Rural Upliftment' && <Users size={20} className="text-orange-400" />}
//             {post.category === 'Healthcare and Sanitation' && <Heart size={20} className="text-blue-400" />}
//             {post.category === 'Waste Management' && <Trash2 size={20} className="text-gray-400" />}
//             {post.category === 'Environment' && <Leaf size={20} className="text-green-400" />}
...
//         'Environment'
//       ];
//       const isOtherCategory = !predefinedCategories.includes(editingPost.category);
